   <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="input-group w-75">
                    ...
                    <div class="input-group-append">
                      <button class="btn btn-primary btn-sm px-4" type="button" id="button-addon2" onclick="applyCoupon(true)">Apply</button>
                    </div>
                  </div>
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                <h2 class="h3 mb-3 text-black">Your CartList</h2>
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody id='prodList'>
                      ...
                      <tr>
                        ...
                        <td class="text-black" id='subTot'></td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Sale</strong></td>
                        <td class="text-black" id='subSale'></td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                        <td class="text-black font-weight-bold"><strong id='tot'></strong></td>
                      </tr>
                  </table>
    ...
    <script src="/pharmaShop/static/libraries/js/pharma_checkout.js"></script>
    <script> var couponCd = <?php  
     if ( empty( $couponCd ) ) {
        echo 'undefined';
      } else {
        echo "'".$couponCd."'";
